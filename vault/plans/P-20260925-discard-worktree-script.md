...
| T-02 | review | 1 | T-01 | scripts/install.sh に discard_worktree.sh を配布対象・マニフェスト対象として追加する | |
| T-03 | review | 1 | T-01 | .claude/skills/run/SKILL.md 手順6.3.2 を discard_worktree.sh 呼び出しに置き換える | |
