...
|---|---|---|---|---|---|
| T-01 | todo | 0 | - | verifier エージェント定義に worktree からメインリポジトリへの書き込み先明記を追加する | |
| T-02 | todo | 0 | - | verifier ルール文書への同趣旨の追記を提案ファイルとして下書きする | |
| T-03 | todo | 0 | - | run スキルの verdict 読み取り手順に worktree 側フォールバックを追記する | |
