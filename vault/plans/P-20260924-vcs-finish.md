...
| T-02 | review | 1 | T-01 | run スキルの最終手順を vcs_finish.sh 呼び出しに置き換える | |
| T-03 | review | 1 | T-01 | design スキルの最終手順を vcs_finish.sh 呼び出しに置き換える | |
| T-04 | review | 1 | T-01 | vault-spec.md の done 定義と設計文書のブランチ・PR 節を vcs_finish.sh 経由の記述に更新する | |
