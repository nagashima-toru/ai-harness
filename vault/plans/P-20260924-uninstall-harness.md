...
|---|---|---|---|---|---|
| T-01 | todo | 0 | - | scripts/unmerge_claude_md.py を作る（CLAUDE.md からマーカーブロックのみ除去） | |
| T-02 | todo | 0 | - | scripts/unmerge_settings_json.py を作る（settings.json からハーネス由来のエントリのみ除去） | |
...
| T-06 | todo | 0 | T-04 | scripts/smoke.sh に uninstall.sh の回帰テストを追加する | |
